<!-- Banner -->
	...
	<div class="banner_2">
		<div class="banner_2_background" style="background-image: url('{{ asset('assets/images/explore_background.jpg')}}');"></div>
							...
							<div class="row fill_height">
								<div class="col-lg-4 col-md-6 fill_height">
									<div class="banner_2_content">
										...
										<div class="button banner_2_button"><a href="{{url('products')}}">Explore</a></div>
									</div>
